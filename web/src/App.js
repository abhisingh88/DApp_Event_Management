...
import {
  Button, Typography, AppBar, Tabs, Tab, Backdrop, CircularProgress, FormControl,
  Grid, ButtonGroup, Dialog, DialogTitle, DialogContent, DialogActions
...
const colors = {
  white: "#ffffff", black: "#000000", teal: "#2fc4b5", grey: "#7a7a7a", light_grey: "#b5b5b5",
